...
namespace Mango.Services.EmailAPI.Messaging
{
    public class RabbitMQOrdertConsumer : BackgroundService
    {
        ...
        public RabbitMQOrdertConsumer(IConfiguration configuration, EmailService emailService)
        {
            //for direct exchange
        ...
        private async Task HandleMessage(RewardsMessage cartDto)
        {
            _emailService.LogOrderPlaced(cartDto).GetAwaiter().GetResult();
        }
    }
}
